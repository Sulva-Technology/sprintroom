  ...
  return (
    <OfflineProvider>
      <div className="flex h-screen overflow-hidden bg-[#F7F8FA] font-sans selection:bg-primary/20">
        <Sidebar user={user} profile={profile} workspaces={workspaces} recentProjects={recentProjects} />

        <div className="flex flex-col flex-1 w-full min-w-0 relative">
          <Topbar user={user} profile={profile} activeFocus={activeFocus} workspaces={workspaces} />
